...
<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=<?php echo $s5_fonts_highlight ?>" />
<?php } ?>
...
<div id="s5_body_padding">
	...
	<!-- Header -->
		...
		<div id="s5_header_area_inner2">
			<div id="s5_header_wrap" align="center">

				<?php if($s5_pos_logo == "published") { ?>
					<div id="ev_logo_module" style="height:<?php echo $ev_logo_height ?>px;width:<?php echo $ev_logo_width ?>px">
						<?php s5_module_call('logo','notitle'); ?>
					</div>
				<?php } else { ?>
					<img alt="logo"  style="height:<?php echo $ev_logo_height ?>px;width:<?php echo $ev_logo_width ?>px" src="<?php echo $s5_directory_path ?>/images/ev_logo.png" id="ev_logo" onclick="window.document.location.href='<?php echo $LiveSiteUrl ?>'" />
				<?php } ?>

				<!--<?php if($s5_pos_banner == "published") { ?>
					<div id="s5_banner" style="padding-left:<?php echo $ev_logo_width + 10 ?>px">
								...
								<?php if (($s5_login  != "") || ($s5_register  != "")) { ?>
									<div id="s5_loginreg">
											<div id="s5_logregtm">
												...
												<!--<?php if ($s5_user_id) { } else if ($s5_register != "") {?>
	...
	<a title="estradavelasquez.com" href="http://www.estradavelasquez.com" target="blank" id="ev_bottom_logo"></a>
